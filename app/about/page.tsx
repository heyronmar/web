        ...
        <div className='flex flex-col'>
          <div className='xl:max-w-[80%] py-8'>
            <h1 className='text-3xl font-extralight text-zinc-600 leading-snug tracking-wide pb-6'>
              <span className='text-zinc-700'>I’m a digital designer obsessed withhuman-computer interaction</span>. I have a wide experience in <span className='underline decoration-blue-300 '>UX</span>, <span className='underline decoration-blue-300 '>mobile app & web design</span>, <span className='underline decoration-blue-300 '>design systems</span>, <span className='underline decoration-blue-300 '>research & testing</span>, <span className='underline decoration-blue-300 '>product strategy</span>, <span className='underline decoration-blue-300 '>product management</span>, <span className='underline decoration-blue-300 '>design and engineering</span>. <span className='text-zinc-700'>My goal is to design solutions that bring <span className='bg-teal-200'>delightful experiences to users</span> while meeting <span className='bg-teal-200'>business requirements</span>.</span>
            </h1>
            {/* <div>
